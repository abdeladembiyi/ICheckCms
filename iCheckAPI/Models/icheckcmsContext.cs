...
{
    public partial class icheckcmsContext : DbContext
    {
        public icheckcmsContext()
        {
        }

        public icheckcmsContext(DbContextOptions<icheckcmsContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=.;Database=icheckcms;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Conducteur>(entity =>
            {
                ...
                entity.Property(e => e.NumBadge)
                    .HasColumnName("numBadge")
                    .HasMaxLength(80)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<Users>(entity =>
            {
                ...
                entity.HasOne(d => d.IdroleNavigation)
                    ...
                    .HasConstraintName("FK__users__idrole__5EBF139D");
            });
            ...
            modelBuilder.Entity<Vehicule>(entity =>
            {
                ...
                entity.HasOne(d => d.IdEnginNavigation)
                    ...
                    .HasConstraintName("FK__vehicule__idEngi__619B8048");
            });
        }
    }
}
